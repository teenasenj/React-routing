...
//                  (<img src={url} alt="teena" title="" className="img-thumbnail w-25"/>
//                 ))
//     }
//     </div>
//         {/* <div className="alignment">    */}
//     <div className="form-group" > 
//     <input type="file"  className="form-control ms-5 w-25" onChange={this.uploadMultipleFiles} 
//     multiple />
//     <br></br>
//     <button type="button" className="btn btn-primary ms-5" onClick={this.uploadFiles}>upload</button>
//         </div>
//         </form>
//         </div>
//         )
